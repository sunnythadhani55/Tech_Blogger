...
public class CollectionServiceImpl implements CollectionService{
	...
	public CollectionDTO add(CollectionDTO collectionDTO, Long userId){
		...
		Set<ArticleDTO> articleDTOList=collectionDTO.getArticleDTOList();
	...
	public CollectionDTO update(CollectionDTO collectionDTO, Long userId){
		Collection collection = collectionRepository.findById(collectionDTO.getId())
				.orElseThrow(() -> new ResourceNotFoundException("Collection", "Id",collectionDTO.getId().toString()));
