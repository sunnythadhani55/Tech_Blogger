...
public class TagServiceTest {
	...
	void should_throw_ResourceNotFoundException_when_find_tag_by_id(){
		...
		Exception exception=assertThrows(ResourceNotFoundException.class, () -> tagService.getById(20L),"Tag");
	...
	void should_throw_ResourceAlreadyExistsException() {	
		...
		assertEquals("Tag already exists, can't create duplicate entry for the same!", exception.getMessage());
	}
	...
	void should_throw_ResourceNotFoundException_when_called_update_method(){
		...
		Exception exception=assertThrows(ResourceNotFoundException.class, () -> tagService.update(tagDTO));
	...
	void deleteTagById_InValidInput_Shouldthrow_ResourceNotFoundException() {
		...
		Exception exception=assertThrows(ResourceNotFoundException.class, () -> tagService.deleteById(id));
