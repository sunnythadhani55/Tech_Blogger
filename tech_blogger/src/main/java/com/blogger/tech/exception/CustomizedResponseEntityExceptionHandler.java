...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public final ResponseEntity<ErrorDetails> handleGlobalException(Exception ex,
      WebRequest request) {
  ...
  public final ResponseEntity<ErrorDetails> handleUnauthorizedException(Exception ex,
      WebRequest request) {
    ErrorDetails errorDetails =
        new ErrorDetails(LocalDateTime.now(), ex.getMessage(), request.getDescription(false));
    ex.printStackTrace();
  ...
  public final ResponseEntity<ErrorDetails> handleIllegalStatusException(Exception ex,
      WebRequest request) {
    ErrorDetails errorDetails =
        new ErrorDetails(LocalDateTime.now(), ex.getMessage(), request.getDescription(false));
    ex.printStackTrace();
  ...
  public final ResponseEntity<ErrorDetails> handleDataIntegrationViolationException(
  ...
  public final ResponseEntity<ErrorDetails> handleConstraintFoundException(
      ConstraintViolationException ex, WebRequest request) {

    Set<ConstraintViolation<?>> violations = ex.getConstraintViolations();
    ErrorDetails errorDetails =
        new ErrorDetails(LocalDateTime.now(),
            "Total Errors are : " + violations.size() + " , First Error : "
